    ...
    if (activeCategory === 'support') {
      return (
        <div>
          ...
          <div className="space-y-3">
            <a href="https://wa.me/91911904529" target="_blank" rel="noreferrer" className="flex items-center gap-3 p-3 bg-green-50 hover:bg-green-100 rounded-xl text-green-700 font-bold transition">
